function separateloopstwolayer(xcoilbig,ycoilbig,zcoilbig,...
...
if Ivalt<Ival
 ...
 Ival=1000;
for i=1:numel(xcoilbig{Nbig})
[Ivalt,bigtofig8t]=min((0.05-xcoilbig{Nbig}(i)).^2+...
                       (ycoilside{Nside/2}-ycoilbig{Nbig}(i)).^2+...
                       (zcoilside{Nside/2}-zcoilbig{Nbig}(i)).^2);
if Ivalt<Ival
    Ival=Ivalt;
    sidetobig=bigtofig8t;          
    bigtoside=i;          
end
end
...
if cid==1
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,cid,...
    [stind:numel(xcoilbig{cid}) 1:stind-40],h2,h1,rs,res,Fsym1,nrs);
else
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,cid,...
    [stind:numel(xcoilbig{cid}) 1:stind-40],h2,h2,rs,res,Fsym1,nrs);
end
end

[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,...
    [bigtobig+20:bigtoside],h1,h2,rs,res,Fsym1,nrs);

nnn=numel(rs(:,1));
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilside,ycoilside,zcoilside,2,...
    [sidetobig+20:numel(xcoilside{Nside/2}) 1:sidetobig-20] ,h1,h1,rs,res,Fsym1,nrs);
if Nside>2
cid=Nside;
...
if ct==0
    ct=ct+1;
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilside,ycoilside,zcoilside,cid,...
    [stind:numel(xcoilside{cid}) 1:stind-40],h2,h1,rs,res,Fsym1,nrs);
else
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilside,ycoilside,zcoilside,cid,...
    [stind:numel(xcoilside{cid}) 1:stind-40],h2,h2,rs,res,Fsym1,nrs);
end
end
...
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,...
    [bigtoside+80:bigtofig8],h1,h2,rs,res,Fsym1,nrs);
    
        rsentry=[-xcoilbig{Nbig}(bigtoside+80)...
                 ycoilbig{Nbig}(bigtoside+80)...
                 zcoilbig{Nbig}(bigtoside+80)]; 

%%fig81andside
 gaplen=40*ones([Nfig8-1,1]);
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilfig8,ycoilfig8,zcoilfig8,Nfig8,...
    cat(2,fig8tobig:numel(xcoilfig8{Nfig8}),1:fig8tofig8-gaplen(end)/2),h1,h1,rs,res,Fsym1,nrs);
cid=Nfig8;
...
stind=stind+gaplen(cid-1);
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilfig8,ycoilfig8,zcoilfig8,cid,...
    [stind:numel(xcoilfig8{cid}) 1:stind],h2,h2,rs,res,Fsym1,nrs);
...
cid=Nbig;
[~,stind2]=min((xcoilbig{cid}-rsentry(1)).^2+...
              (ycoilbig{cid}-rsentry(2)).^2+...
              (zcoilbig{cid}-rsentry(3)).^2);

[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,numel(zcoilbig),...
    [stind:stind2-20] ,h1,h1,rs,res,Fsym1...
    ,nrs);
nrs=nrstore;
...
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,[stind:coilstind-40] ,h1,h1,rs,res,Fsym1...
    ,nrs);
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,[coilstind:numel(zcoilbig{Nbig}) 1:coilstind-40] ,h2,h1,rs,res,Fsym1...
    ,nrs);
