...
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,...
    [bigtobig+20:bigtoside],h1,h1,rs,res,Fsym1,nrs);
...
[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,Nbig,...
    [bigtoside+80:bigtofig8],h1,h1,rs,res,Fsym1,nrs);
...
cid=Nbig;
[~,stind2]=min((xcoilbig{cid}-rsside(end,1)).^2+...
              (ycoilbig{cid}-rsside(end,2)).^2+...
              (zcoilbig{cid}-rsside(end,3)).^2);

[rs,nrs,wid1(end+1),wid2(end+1)]=coilsegment2(xcoilbig,ycoilbig,zcoilbig,numel(zcoilbig),...
    [stind:stind2-20] ,h1,h3,rs,res,Fsym1...
    ,nrs);
nrs=nrstore;
