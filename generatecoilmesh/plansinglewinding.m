function plansinglewinding(filename,outfile)
...
rs=coilsegment(xcoil,ycoil,zcoil,6,[4626:numel(xcoil{6}) 1:1473] ,h1,h1,[],res,Fsym1...
...
rs=coilsegment(xcoil,ycoil,zcoil,6,[1564:4626],h1,h2,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
%y=29 to 32
rs=coilsegment(xcoil,ycoil,zcoil,7,[436:683],h1,h1,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
rs=coilsegment(xcoil,ycoil,zcoil,9,[221:numel(xcoil{9}) 1:191] ,h1,h1,rs,res,Fsym1...
 ...
 rs=coilsegment(xcoil,ycoil,zcoil,9,[215:numel(xcoil{9}) 1:140] ,h2,h1,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
 rs=coilsegment(xcoil,ycoil,zcoil,7,[763:numel(xcoil{7}) 1:120],h1,h2,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);

 % 
 rs=coilsegment(xcoil,ycoil,zcoil,8,[539:numel(xcoil{8}) 1:509],h1,h1,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
rs=coilsegment(xcoil,ycoil,zcoil,8,[535:numel(xcoil{8}) 1:448],h2,h1,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
 rs=coilsegment(xcoil,ycoil,zcoil,7,[214:419],h1,h2,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
% 
...
%    ,xcoil2,ycoil2,zcoil2);
 ...
 rs=coilsegment(xcoil,ycoil,zcoil,5,[378:numel(xcoil{5}) 1:337],h2,h2,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
 rs=coilsegment(xcoil,ycoil,zcoil,7,[460:numel(xcoil{7}) 1:439],h2,h2,rs,res,Fsym1...
    ,xcoil2,ycoil2,zcoil2);
...
save(strcat(outfile,'_coilmesh.mat'),'te2p','p','reg','port','portid');
t2p=surftri(p,te2p);
  tr.faces=t2p;
  tr.vertices=p;
stlwrite(strcat(outfile,'_coilwindingsrena.stl'),tr)
...
%%
  %%%%%%generate coil model
  meshfile=strcat(outfile,'_coilmesh.mat');
