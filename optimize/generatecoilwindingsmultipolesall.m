...
X = fmincon(@(levs)costfnall3(levs(1:end-1),Eoutreg,pmod2,t2pmod2,Attmod2,levs(end),Nv,nhhmod),X0,Aine,Bine,[],[],...
    LB,UB,@(levs) mycon(levs(1:end-1),cdist,Nv),options);
normi=X(end)
c=costfnall3(X(1:end-1),Eoutreg,pmod2,t2pmod2,Attmod2,normi,Nv,nhhmod)
