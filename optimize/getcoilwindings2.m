 [xcoil,ycoil,zcoil,zzcoil,Fsym1,Fsym2...
    ]=getcoilwindings2(harmfile,designfile,nlayers,coilid,N,Ncc);
load(harmfile);
load(designfile);
load C:\Users\ljg24\Desktop\postproc\generatecoil\firstordercorr_middle.mat
psym=psym2;
