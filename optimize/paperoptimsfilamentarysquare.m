...
filename='paperover2optimshalfsphere';
...
save(strcat('C:\Users\ljg24\Desktop\Coiloptcode\optimize\PAPERhalfsphereWOUT1002',num2str(dept),'.mat'),'Wi','Si','Ssq','peakJ','peakSR','Escalp','Escalp12','Ndep','Evol','Edecay','Escalp','Ndepsq');
peakSR
ct=ct+1;
end
%%
