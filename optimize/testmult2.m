...
dept=157;Wc=107;Sc=15.2;
Ncc=24;
coilid=4;
coilid2=4;
designfile=strcat('optimT3w100d',num2str(dept),'ncoils24lmax30.mat');
...
[xcoilbig,ycoilbig,zcoilbig,zzcoilbig,...
          ...
          xcoilside,ycoilside,zcoilside,zzcoilside]=generatecoilwindingsmultipolesall2(harmfile,designfile,1,coilid,coilid2,10,Ncc);
close all
%save largecoil.mat
 %%
 load largecoil.mat
...
%
outfile='hh';
addpath('..\..\Coiloptcode\generatecoilmesh');
...
axis equal
Ldc=real(Ldc);
addpath('..\..\Coiloptcode\generatecoilmesh\figure8coilmodelgenerator\ANAT_Sphere_code');
