...
if loo==1
   ...
   [A,jac,slack,refl,tind]...
    =generatenewmesh(Aloo,jacloo,slackloo,refl,tind,A,x,ncoils,[stv(1) env(2)]/condi,[68 93]/condi);
    elseif loo==3%[48 90]
   [A,jac,slack,refl,tind]...
    =generatenewmesh(Aloo,jacloo,slackloo,refl,tind,A,x,ncoils,[stv(2) env(2)]/condi,[68 93]/condi);
    elseif loo==4%[48 85]
   [A,jac,slack,refl,tind]...
    =generatenewmesh(Aloo,jacloo,slackloo,refl,tind,A,x,ncoils,[stv(3) env(3)]/condi,[68 90]/condi);
    end%[48 70]
end
...
ct=1;
bine=100/sqrt(2)*ones([Nang*numel(slack)+nsamp*ncoils 1]);
