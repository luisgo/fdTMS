...
ener=[250 250 250 250 250 250 250 250];
peakSR2=10^4*[7 6.75 6.5 6.25 6 5.75 5.5 5.25];
...
save(strcat('C:\Users\ljg24\Desktop\Coiloptcode\optimize\diffdepthhatresultsw100',num2str(dept),'.mat'),'Wi','Si','Ssq','peakJ','peakSR','Escalp','Escalp12','Ndep','Evol','Edecay','Escalp','Ndepsq');
peakSR
ct=ct+1;
end
%%
