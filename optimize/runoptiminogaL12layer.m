function ncoils = runoptiminogaL12(depth,energy,ncoils,harmfile,filename)
lmax=20;
...
%% run optimisation
Jmax=10^6*[ 2.8640    3.7288    4.7423    6.0318]/2;
...
x2{jj}=x;
 ...
 save(strcat(sourcefol,filenamesav,num2str(lmax),...
'twolayer.mat'),'-v7.3','Jcalc','Jcalc2','Menergy','Lmat','exflag');
end
end
